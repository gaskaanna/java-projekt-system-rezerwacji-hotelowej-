...
class RoleBasedAccessAspectManagerTest {
    ...
    @Test
    void checkAccess_WithManagerRoleForReservationConfirm_ShouldProceed() throws Throwable {
        // Arrange
        mockAuthenticationWithRole(RoleName.MENAGER);
        mockAnnotation(new RoleName[]{}, false, RoleBasedAccess.ResourceType.RESERVATION, 
                new RoleBasedAccess.Operation[]{RoleBasedAccess.Operation.CONFIRM});
    ...
    @Test
    void checkAccess_WithManagerRoleForReservationCancel_ShouldProceed() throws Throwable {
        // Arrange
        mockAuthenticationWithRole(RoleName.MENAGER);
        mockAnnotation(new RoleName[]{}, false, RoleBasedAccess.ResourceType.RESERVATION, 
                new RoleBasedAccess.Operation[]{RoleBasedAccess.Operation.CANCEL});
        when(joinPoint.proceed()).thenReturn("Success");
    ...
    @Test
    void checkAccess_WithManagerRoleForNonReservationResource_ShouldThrowException() throws Throwable {
        // Arrange
        mockAuthenticationWithRole(RoleName.MENAGER);
        mockAnnotation(new RoleName[]{}, false, RoleBasedAccess.ResourceType.ROOM, 
    ...
    @Test
    void checkAccess_WithManagerRoleForReservationUpdate_ShouldThrowException() throws Throwable {
        // Arrange
        mockAuthenticationWithRole(RoleName.MENAGER);
        mockAnnotation(new RoleName[]{}, false, RoleBasedAccess.ResourceType.RESERVATION, 
                new RoleBasedAccess.Operation[]{RoleBasedAccess.Operation.UPDATE});
